                ...
                <div>
                    <React.Fragment>
                        <Container fixed id="gps">
                            ...
                            <Typography component="div" style={{ backgroundColor: "rgb(133, 175, 204)", height: '100vh' }}>
                                <br />
                                ...
                                <div className="google-map-code" align="middle">
                                    <iframe src={location.state.place} width="450px" height="450px" frameborder="0" style={{ border: 0 }} allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                                </div>
                            </Typography>
                        </Container>
                    </React.Fragment>
